...
h.fcst_lev,
'WIND' fcst_var,
'VAL1L2_ANOM_CORR' stat_name,
ld.total, ld.ufabar, ld.vfabar, ld.uoabar, ld.voabar, ld.uvfoabar, ld.uvffabar, ld.uvooabar, 'NA' stat_value,
'NA' stat_ncl,
'NA' stat_ncu,
'NA' stat_bcl,
'NA' stat_bcu
