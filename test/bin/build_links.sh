...
# in the public data tree under the vsdb_data directory. Matching files will be linked to the appropriate target subdirectory.
# Subdirectories in the target directory will be created as needed.

# example:
# build_links.sh  -s /public/retro/pierce -t /home/pierce/test_data -p 20190[12]
